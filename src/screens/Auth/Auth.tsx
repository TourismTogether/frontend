...
import { Mountain, MapPin, Users, Wallet, BookOpen, Sparkles } from 'lucide-react';
      ...
      <div className="max-w-6xl w-full grid grid-cols-1 lg:grid-cols-2 gap-12 items-center relative z-10">
        ...
        <div className="text-white space-y-8 hidden lg:block animate-fade-in">
          <div className="flex items-center space-x-3 mb-6">
            ...
            <h1 className="text-5xl font-bold drop-shadow-lg">AdventureMate</h1>
          </div>
        ...
        <div className="lg:hidden text-white text-center mb-8 animate-fade-in">
          <div className="flex items-center justify-center space-x-3 mb-4">
            ...
            <span className="text-3xl font-bold drop-shadow-lg">AdventureMate</span>
          </div>
